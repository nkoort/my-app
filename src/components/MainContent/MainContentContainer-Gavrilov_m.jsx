...
import { getProfileTH, getStatusTH, updateProfilePhotoTH, updateStatusTH } from '../../Redux/profile-reducer';
...
let mapStateToProps = (state) => ({
  ...
  photoName: state.profilePage.photoName,

})
  export default compose (
    
    connect ( mapStateToProps, { getProfile: getProfileTH, getStatus: getStatusTH, updateStatus: updateStatusTH, updateProfilePhoto: updateProfilePhotoTH}),
    // withAuthRedirect,
